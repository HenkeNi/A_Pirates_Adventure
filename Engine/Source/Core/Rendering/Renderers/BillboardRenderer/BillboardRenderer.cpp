...
namespace Hi_Engine
{
	...
	BillboardRenderer& BillboardRenderer::GetInstance()
	{
		static BillboardRenderer instance;
		return instance;
	}
	...
	void BillboardRenderer::Render(const BillboardRenderData& someData)
	{
	...
	void BillboardRenderer::SetCamera(Camera* aCamera)
	{
		m_camera = aCamera;
	}
}