...
namespace Hi_Engine
{
	...
	public:
		...
		void			Dispatch(EventListener& listener) override; // mark final?
		ePriority		GetPriority()						const override;	// mark final? OR DONT HAVE FUNCTION RETURN MEMBER? REMOVE AND RETURN DIRECTLY?
...
#pragma region Method_Definitions
	...
	template <typename Derived>
	void Event<Derived>::Dispatch(EventListener& listener)
	{
		listener.OnEvent(static_cast<Derived&>(*this));
	}
